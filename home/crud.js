var selectedRow = null;
    ...
    function loadProducts() {
      ...
      if (loggedInUser) {
        const products = JSON.parse(localStorage.getItem(loggedInUser.email + "_products")) || [];
    ...
    function saveProducts(products) {
      const loggedInUser = JSON.parse(sessionStorage.getItem('loggedInUser'));
      if (loggedInUser) {
        localStorage.setItem(loggedInUser.email + "_products", JSON.stringify(products));
      } else {
        alert('Você não está logado!');
    ...
    document.querySelector("#product-form").addEventListener("submit", (e) => {
      ...
      const products = JSON.parse(localStorage.getItem(JSON.parse(sessionStorage.getItem('loggedInUser')).email + "_products")) || [];
